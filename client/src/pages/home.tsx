        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 max-w-xl">
              <Badge variant="secondary" className="px-4 py-1 text-primary bg-primary/10 hover:bg-primary/20 rounded-full border-2 border-primary/20">
              ...
              <h1 className="text-4xl md:text-6xl font-heading font-black leading-tight text-foreground">
                Preloved Children's Books, <span className="text-accent underline decoration-primary decoration-8 decoration-wavy underline-offset-8">Loved Twice</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button variant="outline" size="lg" className="rounded-full text-base px-8 h-14 border-4 border-secondary text-secondary-foreground font-black text-xl hover:bg-secondary/20" asChild>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className={`w-20 h-20 ${feature.color} rounded-[2rem] flex items-center justify-center mx-auto mb-8 transform ${i % 2 === 0 ? 'rotate-6' : '-rotate-6'} border-4 shadow-lg`}>
